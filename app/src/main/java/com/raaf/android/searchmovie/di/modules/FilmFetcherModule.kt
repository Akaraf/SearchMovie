...
class FilmFetcherModule {
    ...
    @Provides
    @Singleton
    fun provideFilmFetcher(topDatabase: TopDatabase, myFilmsDatabase: MyFilmsDatabase, compilationDatabase: CompilationDatabase, watchedDatabase: WatchedDatabase, releasesDatabase: ReleasesDatabase, popularPersonDatabase: PopularPersonDatabase, myPersonsDatabase: MyPersonsDatabase, moviesForPersonCacheDatabase: MoviesForPersonCacheDatabase, categoryDatabase: CategoryDatabase, categoryFilmsCacheDatabase: CategoryFilmsCacheDatabase, appConverter: AppConverter, app: Application) : FilmFetcher {
        return FilmFetcher(topDatabase, myFilmsDatabase, compilationDatabase, watchedDatabase, releasesDatabase, popularPersonDatabase, myPersonsDatabase, moviesForPersonCacheDatabase, categoryDatabase, categoryFilmsCacheDatabase, appConverter, app.applicationContext)
    }
