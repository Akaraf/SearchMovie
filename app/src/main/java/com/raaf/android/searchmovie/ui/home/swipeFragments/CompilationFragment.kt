    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        compilationViewModel.list.observe(
                ...
                Observer { list ->
                    ...
                    val listCategory = listOf(FilmsCategoryItem(nameCompilationForUI[0], list1),
                            FilmsCategoryItem(nameCompilationForUI[1], list2),
                            FilmsCategoryItem(nameCompilationForUI[2], list3),
                            FilmsCategoryItem(nameCompilationForUI[3], list4),
                            FilmsCategoryItem(nameCompilationForUI[4], list5))
